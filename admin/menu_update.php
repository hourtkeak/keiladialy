...
if($_FILES["img_menu"]["name"]!=""){
	...
	$stmt_menu= $DB_con->prepare("UPDATE menu SET c_title=:t_menu, c_headline=:t_menu_headline, c_desc=:menu_desc, 
...
echo "<script type='text/javascript'>window.location='../sr-admin.php?page=add_menu&action=edit&menu_id=".$menu_id."&msg=".$msg."&img_smg=".@$img_alert."'</script>";
